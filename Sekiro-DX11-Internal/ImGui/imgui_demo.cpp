...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    ImGui::Checkbox("circle fov", &test);
    ImGui::SliderFloat("circle", &size, 0, 1920, "%.3f size");
    ...
    if (test) {
        ...
        draw->AddCircle(ImVec2(800 / 2, 450 / 2),size, IM_COL32(255,0,0,255),100,3.0f);
        draw->AddLine(ImVec2(0, 0), ImVec2(800 / 2, 450 / 2), IM_COL32(255, 0, 0, 255), 1.0f);
        draw->AddText(ImVec2(800 / 2, 450 / 2), IM_COL32(255, 0, 0, 255),"test","macher");
        ImGui::End();
    }
